...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border ring-offset-background",
      ...
      "px-3 py-2 text-sm [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 opacity-50 text-[var(--lg-gray-dark-1)] dark:text-[var(--lg-gray-light-1)]" />
